...
週末（ニューヨーク現地の土日）は時刻によらず Closed。祝日は判定しない（海外休場日マスタの責務）。
...
| MKS-12 | 土曜 `2026-03-07T15:00:00Z`（NY 10:00 EST。Regular の時間帯） | `getMarketStatus(date)` | `closed` /「○ Closed」 | 実装済 |
| MKS-13 | 日曜 `2026-03-08T15:00:00Z`（NY 11:00 EDT。Regular の時間帯） | 同上 | `closed` | 実装済 |
